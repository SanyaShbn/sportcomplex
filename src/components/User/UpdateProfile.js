    ...
    .then(response => {
      ...
      if (!response.ok) {
        ...
        payload: {
          open: true,
          severity: 'error',
          message: 'Ошибка! Не удалось обновить данные учетной записи. Возможно, введенные вами значения '
          + 'номера телефона или обновленного адреса электронной почты уже используются другими сотрудниками (или клиентами)',
        },});
      }
      else {
        clearValues()
